...
@section('title', 'Terms and Conditions - ' . \App\Models\SiteSetting::get('site_name', 'YL Legacy'))
...
<section class="section-padding" style="background: #ffffff;">
    <div class="container" style="max-width: 860px;">
        <div class="section-header" style="text-align: left; margin-bottom: 30px;">
            ...
            <p>Last updated: {{ date('F Y') }} • Legal Entity: <strong>YL Legacy LLC</strong></p>
        </div>

        <div style="font-size: 15px; color: var(--text-muted); line-height: 1.8;">
            <p style="margin-bottom: 20px;">
                Welcome to <strong>YL Legacy LLC</strong> ("Company," "we," "our," or "us"). These Terms and Conditions govern your access to our website, dedicated account management services, e-commerce consulting agreements, and digital turnkey store solutions.
            </p>

            <h3 style="color: var(--accent); font-size: 19px; margin: 28px 0 12px;">1. Dedicated Management & Scope</h3>
            <p style="margin-bottom: 20px;">
                YL Legacy provides dedicated operational management, listing architecture, advertising optimization, and fulfillment coordination across Amazon, Walmart, eBay, TikTok Shop, and Shopify. The client retains 100% legal ownership of their merchant accounts, trademarks, and payout accounts.
            </p>
            ...
            <p style="margin-bottom: 20px;">
                Legal notices may be submitted to <a href="mailto:{{ \App\Models\SiteSetting::get('contact_email', 'support@yllegacy.com') }}" style="color: var(--primary); font-weight: 600;">{{ \App\Models\SiteSetting::get('contact_email', 'support@yllegacy.com') }}</a> or mailed to:
            </p>
