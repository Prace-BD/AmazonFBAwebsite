...
@section('title', 'Privacy Policy - ' . \App\Models\SiteSetting::get('site_name', 'OYL Legacy'))
...
<section class="section-padding" style="background: #ffffff;">
    <div class="container" style="max-width: 860px;">
        <div class="section-header" style="text-align: left; margin-bottom: 30px;">
            ...
            <p>Last updated: {{ date('F Y') }} • Entity: <strong>OYL Legacy LLC</strong></p>
        </div>

        <div style="font-size: 15px; color: var(--text-muted); line-height: 1.8;">
            <p style="margin-bottom: 20px;">
                <strong>OYL Legacy LLC</strong> ("we," "our," or "us") is dedicated to protecting your privacy. This Privacy Policy details how we collect, handle, and safeguard your personal information when you browse our site or use our dedicated account management services.
            </p>
