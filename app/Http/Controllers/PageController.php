...
class PageController extends Controller
{
    ...
    public function pageList()
    {
        $pages = [
            ...
            ['title' => 'Page List Directory', 'route' => 'pages.index', 'url' => route('pages.index'), 'badge' => 'Navigation', 'desc' => 'Interactive visual map of all OYL Legacy templates, services, legal compliance policies, and control centers.'],
            ...
            ['title' => 'Terms and Conditions', 'route' => 'terms', 'url' => route('terms'), 'badge' => 'Legal', 'desc' => 'OYL Legacy LLC entity identification, service level agreements, and governing law.'],
            ...
            ['title' => 'Unified Theme Control Center', 'route' => 'admin.theme-control', 'url' => route('admin.theme-control'), 'badge' => 'OYL Legacy Panel', 'desc' => 'Real-time dashboard to control site colors, hotline, USD package prices, forwarding emails, and lead inbox.'],
        ];
